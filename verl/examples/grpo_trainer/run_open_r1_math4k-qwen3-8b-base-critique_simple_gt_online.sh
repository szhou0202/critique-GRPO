...
export DATA_DIR=openr1_math_4k_train_qwenformat
...
export HDFS_CHECKPOINT_PATH=./rl_tuned_ckpts
...
CUDA_VISIBLE_DEVICES=0,1 python3 -m verl.critique_grpo.critique_main_ppo \
